...
import gpr.com.gprapplication.service.AddFavoritePhysicianService;
...
public class AddFavoritePhysicianServiceTask extends
	...
	private Suggest favorite;


	public AddFavoritePhysicianServiceTask(Activity activity, Suggest favorite) {
		super();
...
//		superActivityToast.setProgress(40);
		...
		try {
			AddFavoritePhysicianService service = new AddFavoritePhysicianService(CredentialManager.getInstance().get(null));
			ret = service.getParseJson(new Long (favorite.getId()).toString());
