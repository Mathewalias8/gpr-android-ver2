...
public class BaseReferralListTask extends BaseAsyncTask<String, String, List<Referral>> {

    ProgressDialog dialog;
    public static final String CLASS_NAME = "JsonIncomingServiceTask";
...
//        }
    ...
    protected List<Referral> doInBackground(String... param) {
        ...
        try {
            incomingReferrals = new IncomingReferralListService(param[0])
