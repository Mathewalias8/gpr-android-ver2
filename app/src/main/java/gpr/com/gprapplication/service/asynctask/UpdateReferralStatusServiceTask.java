...
public class UpdateReferralStatusServiceTask extends
	...
	public UpdateReferralStatusServiceTask(Activity activity, Referral currentReferral,String status) {
		super();
...
//		superActivityToast.setProgress(40);
		...
		try {
			UpdateReferralStatusService service = new UpdateReferralStatusService(CredentialManager.getInstance().get(null));
			ret = service.getParseJson(new Long ( currentReferral.getId()).toString(), status);
